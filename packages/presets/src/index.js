...
export const PRESETS = {
  ...
  fashion: {
    ...
    layout: [
      ...
      { section: 'product_grid', props: { title: 'Hàng mới về' } },
      { section: 'story', props: {
  ...
  food: {
    ...
    description: 'Tươi – sạch – ngon mắt: xanh lá tươi + cam đất trên nền kem, bo góc tròn, đẩy cam kết tươi/giao nhanh lên trước.',
    tokens: {
      'color.primary': '#2f7d32',
      'color.primary-dark': '#1b5e20',
      'color.accent': '#e8632a',
      'color.bg': '#fffdf7',
      'color.surface': '#f4efe1',
      'color.hero-bg': '#ecf1e0',
      'color.text': '#17301c',
      'color.muted': '#5f6b4f',
      'color.border': '#e4ddca',
      radius: '14px',
    ...
    layout: [
      ...
      { section: 'product_grid', props: { title: 'Bán chạy trong tuần' } },
      { section: 'collections', props: { title: 'Mua sắm theo danh mục' } },
      { section: 'story', props: {
        title: 'Từ nông trại đến bữa cơm nhà bạn',
        body: 'Chúng tôi làm việc trực tiếp với các nông hộ và hợp tác xã địa phương, thu hoạch đúng vụ và vận chuyển lạnh trong ngày. Mỗi sản phẩm đều được kiểm tra chất lượng trước khi đến tay bạn — vì một bữa ăn ngon, an toàn và trọn vẹn cho cả gia đình.',
        cta_text: 'Tìm hiểu nguồn hàng',
      } },
      { section: 'blog', props: {} },
      { section: 'footer', props: {} },
    ],
  ...
  furniture: {
    ...
    layout: [
      ...
      { section: 'collections', props: { title: 'Không gian theo phòng' } },
  ...
  cosmetics: {
    ...
    layout: [
      ...
      { section: 'product_grid', props: { title: 'Bán chạy được yêu thích' } },
      { section: 'story', props: {
