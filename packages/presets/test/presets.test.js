...
const VALID_SECTIONS = new Set(['header', 'hero', 'features', 'collections', 'product_grid', 'blog', 'story', 'footer']);
...
for (const slug of SLUGS) {
  ...
  test(`[${slug}] layout hợp lệ (8 section · header đầu · footer cuối · hero gần đầu)`, () => {
