...
#
# BASELINE ĐẾM THEO FILE, KHÔNG THEO SỐ THỨ TỰ. Hôm nay là 172 file trong khi file mới
# nhất mang số 0174 — dãy có khoảng trống (0157 chẳng hạn). Suy số lượng từ số thứ tự là
# sai ngay từ hôm nay.
#
# CÁCH DÙNG
